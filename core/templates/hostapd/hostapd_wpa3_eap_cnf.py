...
hostapd_wpa3_eap_cnf = '''##### hostapd configuration file ##############################################
...
# VLAN ID appended. It defaults to brvlan(int) if no tagged interface is given
# and br(str).(int) if a tagged interface is given, provided (str) = tagged interface
# and (int) = VLAN ID.
#vlan_bridge=brvlan
...
#	1..4294967295; 0 = unknown
# Downlink Load: Current load of downlink WAN connection (scaled to 255 = 100 percentage)
# Uplink Load: Current load of uplink WAN connection (scaled to 255 = 100 percentage)
