...
hostapd_wifi5_open_cnf = f"""##### hostapd configuration file ##############################################
...
accept_mac_file={{macaddr_accept_file}}
deny_mac_file={{macaddr_deny_file}}
...
ignore_broadcast_ssid={{essid_mask}}
...
hostapd_wifi5_wep_cnf = f"""##### hostapd configuration file ##############################################
# Empty lines and lines starting with # are ignored
...
hostapd_wifi5_wpa_cnf = f"""##### hostapd configuration file ##############################################
# Empty lines and lines starting with # are ignored
...
hostapd_wifi5_wpa_eap_cnf = f"""##### hostapd configuration file ##############################################
# Empty lines and lines starting with # are ignored
...
# EAPOL-Key index workaround (set bit7) for WinXP Supplicant (needed only if
# only broadcast keys are used)
eapol_key_index_workaround={{eapol_workaround}}
