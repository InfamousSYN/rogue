...
hostapd_wifi4_open_cnf = f"""##### hostapd configuration file ##############################################
...
hostapd_wifi4_wep_cnf = f"""##### hostapd configuration file ##############################################
# Empty lines and lines starting with # are ignored
...
hostapd_wifi4_wpa_cnf = f"""##### hostapd configuration file ##############################################
# Empty lines and lines starting with # are ignored
...
hostapd_wifi4_wpa_eap_cnf = f"""##### hostapd configuration file ##############################################
# Empty lines and lines starting with # are ignored
