...
hostapd_wifi3_open_cnf = f"""##### hostapd configuration file ##############################################
...
hostapd_wifi3_wep_cnf = f"""##### hostapd configuration file ##############################################
# Empty lines and lines starting with # are ignored
...
hostapd_wifi3_wpa_cnf = f"""##### hostapd configuration file ##############################################
# Empty lines and lines starting with # are ignored
...
hostapd_wifi3_wpa_eap_cnf = f"""##### hostapd configuration file ##############################################
# Empty lines and lines starting with # are ignored
